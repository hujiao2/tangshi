...
function(t) {
	...
	e.DEFAULTS = {
		...
		e += "Text", a.resetText || n.data("resetText", n[o]()), n[o](a[e] || this.options[e]), setTimeout(t.proxy(function() {
			"loadingText" == e ? (this.isLoading = !0, n.addClass(i).attr(i, i)) : this.isLoading && (this.isLoading = !1, n
				.removeClass(i).removeAttr(i))
		}, this), 0)
		...
		if (e.length) {
			...
			"radio" == i.prop("type") && (i.prop("checked") && this.$element.hasClass("active") ? t = !1 : e.find(".active").removeClass(
				"active")), t && i.prop("checked", !this.$element.hasClass("active")).trigger("change")
		}
	...
	n.prototype.close = function(e) {
		...
		var s = t(a);
		e && e.preventDefault(), s.length || (s = o.hasClass("alert") ? o : o.parent()), s.trigger(e = t.Event("close." + i)),
			e.isDefaultPrevented() || (s.removeClass("in"), t.support.transition && s.hasClass("fade") ? s.one(t.support.transition
				.end, n).emulateTransitionEnd(150) : n())
	};
	var o = t.fn.alert;
...
function(t, e) {
	...
	var i = "zui.pager",
		...
		a = function(e, n) {
			var s = this;
			s.name = i, s.$ = t(e), n = s.options = t.extend({}, a.DEFAULTS, this.$.data(), n);
			var r = n.lang || t.zui.clientLang();
			s.lang = t.isPlainObject(r) ? t.extend(!0, {}, o[r.lang || t.zui.clientLang()], r) : o[r], s.state = {}, s.set(n.page,
				n.recTotal, n.recPerPage, !0), s.$.on("click", ".pager-goto-btn", function() {
	...
	a.prototype.set = function(e, i, o, a) {
		...
		r || (r = t.extend({}, n));
		var l = t.extend({}, r);
		return "number" == typeof o && o > 0 && (r.recPerPage = o), "number" == typeof i && i >= 0 && (r.recTotal = i),
			"number" == typeof e && e >= 0 && (r.page = e), r.totalPage = r.recTotal && r.recPerPage ? Math.ceil(r.recTotal / r
				.recPerPage) : 1, r.page = Math.max(0, Math.min(r.page, r.totalPage)), r.pageRecCount = r.recTotal, r.page && r.recTotal &&
			(r.page < r.totalPage ? r.pageRecCount = r.recPerPage : r.page > 1 && (r.pageRecCount = r.recTotal - r.recPerPage *
				(r.page - 1))), r.skip = r.page > 1 ? (r.page - 1) * r.recPerPage : 0, r.start = r.skip + 1, r.end = r.skip + r.pageRecCount,
			r.prev = r.page > 1 ? r.page - 1 : 0, r.next = r.page < r.totalPage ? r.page + 1 : 0, s.state = r, a || l.page ===
			r.page && l.recTotal === r.recTotal && l.recPerPage === r.recPerPage || s.$.callComEvent(s, "onPageChange", [r, l]),
			s.render()
	}, a.prototype.createLinkItem = function(i, n, o) {
		var a = this;
		n === e && (n = i);
		var s = t('<a title="' + a.lang.pageOfText.format(i) + '" class="pager-item" data-page="' + i + '"/>').attr("href",
			i ? a.createLink(i, a.state) : "###").html(n);
		return o || (s = t("<li />").append(s).toggleClass("active", i === a.state.page).toggleClass("disabled", !i || i ===
			a.state.page)), s
		...
		t === e && (t = i.options.maxNavCount || 10), r(1), a > 1 && (a <= t ? r(2, a) : s < t - 2 ? (r(2, t - 2), r(!1), r(
			a)) : s > a - t + 2 ? (r(!1), r(a - t + 2, a)) : (r(!1), r(s - Math.ceil((t - 4) / 2), s + Math.floor((t - 4) / 2)),
			r(!1), r(a)))
	}, a.prototype.createGoto = function() {
		var e = this,
			i = this.state,
			n = t('<div class="input-group pager-goto" style="width: ' + (35 + 9 * (i.page + "").length + 25 + 12 * e.lang[
					"goto"].length) + 'px"><input value="' + i.page + '" type="number" min="1" max="' + i.totalPage +
				'" placeholder="' + i.page +
				'" class="form-control pager-goto-input"><span class="input-group-btn"><button class="btn pager-goto-btn" type="button">' +
				e.lang["goto"] + "</button></span></div>");
		return n
		...
		return t(
			...
			e.lang.pageSize.format(i) + ' <span class="caret"></span></button></div>').addClass(e.options.menuDirection).append(
			n)
		...
		for (var s = 0; s < e.length; ++s) {
			var r = t.trim(e[s]),
				l = a ? o[r] || o : o,
				c = l.call(i, r, i.$, n);
			c === !1 && (c = i.createElement(r, i.$, n)), c instanceof t && ("LI" !== c[0].tagName && (c = t("<li/>").append(c)),
				i.$.append(c))
		}
		var d = null;
		...
		}), d && d.addClass("pager-item-right"), i.$.callComEvent(i, "onRender", [n]), i
	}, a.DEFAULTS = t.extend({
		elements: ["first_icon", "prev_icon", "pages", "next_icon", "last_icon", "page_of_total_text", "items_range_text",
			"total_text"
		],
	...
	}, a.NAME = i, t.fn.pager.Constructor = a, t(function() {
	...
	i.prototype.show = function() {
		...
		function o() {
			a.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"), e.addClass("active"), s ? (e[0].offsetWidth,
				e.addClass("in")) : e.removeClass("fade"), e.parent(".dropdown-menu") && e.closest("li.dropdown").addClass(
				"active"), n && n()
		}
		var a = i.find("> .active"),
	...
	var e = "zui.collapse",
		i = function(e, n) {
			this.$element = t(e), this.options = t.extend({}, i.DEFAULTS, n), this.transitioning = null, this.options.parent &&
				(this.$parent = t(this.options.parent)), this.options.toggle && this.toggle()
		};
	i.DEFAULTS = {
		toggle: !0
		...
		if (!this.transitioning && !this.$element.hasClass("in")) {
			...
			if (this.$element.trigger(i), !i.isDefaultPrevented()) {
				...
				var s = function() {
					this.$element.removeClass("collapsing").addClass("in")[a]("auto"), this.transitioning = 0, this.$element.trigger(
						"shown." + e)
				};
		...
		if (!this.transitioning && this.$element.hasClass("in")) {
			...
			if (this.$element.trigger(i), !i.isDefaultPrevented()) {
				...
				this.$element[n](this.$element[n]())[0].offsetHeight, this.$element.addClass("collapsing").removeClass("collapse")
				...
				return t.support.transition ? void this.$element[n](0).one(t.support.transition.end, t.proxy(o, this)).emulateTransitionEnd(
					350) : o.call(this)
			}
		}
	...
	t.fn.collapse = function(n) {
		...
		var n, o = t(this),
			...
			d = c && t(c);
		r && r.transitioning || (d && d.find('[data-toggle=collapse][data-parent="' + c + '"]').not(o).addClass("collapsed"),
			o[s.hasClass("in") ? "addClass" : "removeClass"]("collapsed")), s.collapse(l)
	})
}(window.jQuery),
function(t, e) {
	"use strict";
	var i = 1200,
		...
		s = function() {
			var t = a.width();
			e("html").toggleClass("screen-desktop", t >= n && t < i).toggleClass("screen-desktop-wide", t >= i).toggleClass(
				"screen-tablet", t >= o && t < n).toggleClass("screen-phone", t < o).toggleClass("device-mobile", t < n).toggleClass(
				"device-desktop", t >= n)
		},
		r = "",
		l = navigator.userAgent;
	l.match(/(iPad|iPhone|iPod)/i) ? r += " os-ios" : l.match(/android/i) ? r += " os-android" : l.match(/Win/i) ? r +=
		" os-windows" : l.match(/Mac/i) ? r += " os-mac" : l.match(/Linux/i) ? r += " os-linux" : l.match(/X11/i) && (r +=
			" os-unix"), "ontouchstart" in document.documentElement && (r += " is-touchable"), e("html").addClass(r), a.resize(s),
		s()
}(window, jQuery),
function(t) {
	"use strict";
	...
	i.prototype.cssHelper = function() {
		var e = this.ie,
			i = t("html");
		i.toggleClass("ie", e).removeClass("ie-6 ie-7 ie-8 ie-9 ie-10"), e && i.addClass("ie-" + e).toggleClass(
			"gt-ie-7 gte-ie-8 support-ie", e >= 8).toggleClass("lte-ie-7 lt-ie-8 outdated-ie", e < 8).toggleClass(
			"gt-ie-8 gte-ie-9", e >= 9).toggleClass("lte-ie-8 lt-ie-9", e < 9).toggleClass("gt-ie-9 gte-ie-10", e >= 10).toggleClass(
			"lte-ie-9 lt-ie-10", e < 10)
		...
		), n.prependTo("body")), n.find(".content").html(i || this.browseHappyTip || e[t.zui.clientLang() || "zh_cn"])
...
function() {
	...
	Date.ONEDAY_TICKS = 864e5, Date.prototype.format || (Date.prototype.format = function(t) {
		...
		for (var i in e) new RegExp("(" + i + ")").test(t) && (t = t.replace(RegExp.$1, 1 == RegExp.$1.length ? e[i] : (
			"00" + e[i]).substr(("" + e[i]).length)));
		return t
	...
	String.prototype.format || (String.prototype.format = function(t) {
		...
		if (arguments.length > 0) {
			...
			if (arguments.length <= 2 && "object" == typeof t)
				for (var n in t) void 0 !== t[n] && (i = new RegExp("(" + (arguments[1] ? arguments[1].replace("0", n) : "{" + n +
					"}") + ")", "g"), e = e.replace(i, t[n]));
			else
				for (var o = 0; o < arguments.length; o++) void 0 !== arguments[o] && (i = new RegExp("({[" + o + "]})", "g"), e =
					e.replace(i, arguments[o]))
		}
		return e
...
function(t, e, i) {
	...
	function e(n, o) {
		...
		this.$element = t(t(n).is("body") ? window : n), this.$body = t("body"), this.$scrollElement = this.$element.on(
				"scroll." + i + ".data-api", s), this.options = t.extend({}, e.DEFAULTS, o), this.selector || (this.selector = (
				this.options.target || (a = t(n).attr("href")) && a.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a"), this.offsets =
			t([]), this.targets = t([]), this.activeTarget = null, this.refresh(), this.process()
	}
	var i = "zui.scrollspy";
	e.DEFAULTS = {
		offset: 10
		...
		i = function(e, n) {
			...
			if (a.length) {
				...
				o.$input = a = a.first(), a.on(n.listenEvent, function(t) {
					...
					var e = 0,
						i = t.which;
					27 === i && n.escToClear ? (this.setSearch("", !0), r(), e = 1) : 13 === i && n.onPressEnter && (r(), o.$.callComEvent(
						o, "onPressEnter", [t]));
			...
			T = function(i) {
				...
				if (!(l > -1 && i.button !== l)) {
					...
					o = h.offset(), n = {
						...
						}, s = t.extend({}, n), r = !1, w.addClass("drag-ready"), i.preventDefault(), v.stopPropagation && i.stopPropagation(),
						t(e).on(m, $).on(g, x)
				}
			};
...
function(t, e, i) {
	...
	s.DEFAULTS = o, s.NAME = n, s.prototype.trigger = function(e, i) {
		...
		var o, a, s, r, l, c, d, p, h, u, f, g, m, v = this,
			...
			I = y,
			M = !1,
			O = S ? t(b.container).first() : k ? y : t("body"),
			j = function(e) {
				if (M && (f = {
						left: e.pageX,
						top: e.pageY
					...
					if (null === s) {
						...
						"absolute" != n && "relative" != n && "fixed" != n && (c = n, O.css("position", "relative")), s = I.clone().removeClass(
							"drag-from").addClass("drag-shadow").css({
							position: "absolute",
							width: I.outerWidth(),
							transition: "none"
					...
					if (o.each(function() {
							...
							if (f.left > a && f.top > s && f.left < a + n && f.top < s + o && (C && C.removeClass(P), C = e, !b.nested))
								return !1
						}), C) {
						r = !0;
						var $ = C.data("id");
						I.data("id") != $ && (l = !1), (null === a || a.data("id") !== $ && !l) && (y = !0), a = C, E && o.removeClass(P),
							a.addClass(P)
					}
					E ? null !== a && a.length && (r = !0) : (I.toggleClass("drop-in", r), s.toggleClass("drop-in", r)), z && z(I, a) ===
						!1 || v.trigger("drag", {
							event: e,
							isIn: r,
							target: a,
			...
			L = function(i) {
				if (t(e).off(C), clearTimeout(m), M) {
					if (M = !1, c && O.css("position", c), null === s) return I.removeClass("drag-from"), void v.trigger("always", {
						event: i,
						cancel: !0
					});
					r || (a = null);
					...
					n = v.trigger("beforeDrop", y), n && r && v.trigger("drop", y), o.removeClass(P), I.removeClass("dragging").removeClass(
						"drag-from"), s.remove(), s = null, v.trigger("finish", y), v.trigger("always", y), i && i.preventDefault()
				}
			},
			A = function(i) {
				...
				if (!(n > -1 && i.button !== n)) {
					var f = t(this);
					k && (I = D ? f.closest(k) : f), I.hasClass("drag-shadow") || b.before && b.before({
						event: i,
						element: I
					}) === !1 || (M = !0, o = t.isFunction(b.target) ? b.target(I, y) : O.find(b.target), a = null, s = null, r = !1,
						l = !0, c = null, d = I.offset(), h = O.offset(), h.top = h.top - O.scrollTop(), h.left = h.left - O.scrollLeft(),
						p = {
							left: i.pageX,
							top: i.pageY
						}, g = t.extend({}, p), u = {
							left: p.left - d.left,
							top: p.top - d.top
						}, I.addClass("drag-from"), t(e).on(T, j).on(x, L), m = setTimeout(function() {
							t(e).on($, L)
						}, 10), i.preventDefault(), b.stopPropagation && i.stopPropagation())
				}
			};
		D ? y.on($, D, A) : k ? y.on($, k, A) : y.on($, A)
	...
	function i(e, i, a) {
		return this.each(function() {
			var s = t(this),
				r = s.data(n),
				l = t.extend({}, o.DEFAULTS, s.data(), "object" == typeof e && e);
	...
	var n = "zui.modal",
		o = function(i, o) {
			var a = this;
			a.options = o, a.$body = t(document.body), a.$element = t(i), a.$backdrop = a.isShown = null, a.scrollbarWidth = 0,
				o.moveable === e && (a.options.moveable = a.$element.hasClass("modal-moveable")), o.remote && a.$element.find(
					".modal-content").load(o.remote, function() {
	...
	var a = function(e, i) {
		var n = t(window);
		i.left = Math.max(0, Math.min(i.left, n.width() - e.outerWidth())), i.top = Math.max(0, Math.min(i.top, n.height() -
			e.outerHeight())), e.css(i)
	};
	o.prototype.toggle = function(t, e) {
		...
		if (i === e && (i = s.position), i !== e && null !== i) {
			...
			var r = o.$element.find(".modal-dialog"),
				...
				d = r.find(".modal-body").css(c);
			if (s.scrollInside) {
				var p = s.headerHeight;
				"number" != typeof p ? p = r.find(".modal-header").height() : t.isFunction(p) && (p = p($header)), c.maxHeight = l -
					p, d.outerHeight() > c.maxHeight && (c.overflow = "auto")
			}
			d.css(c);
			var h = Math.max(0, (l - r.outerHeight()) / 2);
			if ("fit" === i ? i = {
					top: h > 50 ? Math.floor(2 * h / 3) : h
				} : "center" === i ? i = {
					top: h
				} : t.isPlainObject(i) || (i = {
					top: i
				...
				var u = null,
					f = s.rememberPos;
				f && (f === !0 ? u = o.$element.data("modal-pos") : t.zui.store && (u = t.zui.store.pageGet(n + ".rememberPos." +
					f))), i = t.extend(i, {
					left: Math.max(0, (t(window).width() - r.outerWidth()) / 2)
				}, u), "inside" === s.moveable ? a(r, i) : r.css(i)
			} else r.css(i)
		}
		...
		o.toggleClass("modal-moveable", !!i.moveable), e.$element.data("modal-moveable-setup") || o.draggable({
			...
			finish: function(o) {
				var a = i.rememberPos;
				a && (e.$element.data("modal-pos", o.pos), t.zui.store && a !== !0 && t.zui.store.pageSet(n + ".rememberPos." +
					a, o.pos))
			},
		...
		a.$element.trigger(s), a.$element.toggleClass("modal-scroll-inside", !!a.options.scrollInside), a.isShown || s.isDefaultPrevented() ||
			(a.isShown = !0, a.options.moveable && a.setMoveale(), a.checkScrollbar(), a.options.backdrop !== !1 && (a.$body.addClass(
				"modal-open"), a.setScrollbar()), a.escape(), a.$element.on("click.dismiss." + n, '[data-dismiss="modal"]',
				function(t) {
					a.hide(), t.stopPropagation()
				}), a.backdrop(function() {
				var s = t.support.transition && a.$element.hasClass("fade");
				a.$element.parent().length || a.$element.appendTo(a.$body), a.$element.show().scrollTop(0), s && a.$element[0].offsetWidth,
					a.$element.addClass("in").attr("aria-hidden", !1), a.ajustPosition(i), a.enforceFocus();
		...
		var i = this;
		e = t.Event("hide." + n), i.$element.trigger(e), i.isShown && !e.isDefaultPrevented() && (i.isShown = !1, i.options.backdrop !==
			!1 && (i.$body.removeClass("modal-open"), i.resetScrollbar()), i.escape(), t(document).off("focusin." + n), i.$element
			.removeClass("in").attr("aria-hidden", !0).off("click.dismiss." + n), t.support.transition && i.$element.hasClass(
				"fade") ? i.$element.one("bsTransitionEnd", t.proxy(i.hideModal, i)).emulateTransitionEnd(o.TRANSITION_DURATION) :
			i.hideModal())
		...
		this.isShown && this.options.keyboard ? t(document).on("keydown.dismiss." + n, t.proxy(function(i) {
			if (27 == i.which) {
				var o = t.Event("escaping." + n),
					a = this.$element.triggerHandler(o, "esc");
				if (a != e && !a) return;
				this.hide()
			}
		...
		if (this.isShown && this.options.backdrop) {
			...
			if (this.$backdrop = t('<div class="modal-backdrop ' + a + '" />').appendTo(this.$body), this.$element.on(
					"mousedown.dismiss." + n, t.proxy(function(t) {
						t.target === t.currentTarget && ("static" == this.options.backdrop ? this.$element[0].focus.call(this.$element[
			...
			t.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one("bsTransitionEnd", r).emulateTransitionEnd(
				o.BACKDROP_TRANSITION_DURATION) : r()
		} else e && e()
	...
	t.fn.modal = i, t.fn.modal.Constructor = o, t.fn.modal.noConflict = function() {
		...
		if (s.length) {
			var l = s.data(n) ? "toggle" : t.extend({
				remote: !/#/.test(a) && a
			}, s.data(), o.data());
...
function(t, e, i) {
	...
	var n = "zui.modaltrigger",
		...
		s = "string",
		r = function(e, i) {
			e = t.extend({}, r.DEFAULTS, t.ModalTriggerDefaults, i ? i.data() : null, e), this.isShown, this.$trigger = i, this.options =
				e, this.id = t.zui.uuid()
		};
	r.DEFAULTS = {
		type: "custom",
		height: "auto",
		...
		var r = this;
		if (i.url && (!i.type || i.type != o && "iframe" != i.type) && (i.type = o), i.remote) i.type = o, typeof i.remote ===
			s && (i.url = i.remote);
		else if (i.iframe) i.type = "iframe", typeof i.iframe === s && (i.url = i.iframe);
		else if (i.custom && (i.type = "custom", typeof i.custom === s)) {
			var l;
			try {
				l = t(i.custom)
			} catch (c) {}
		...
		var d = t("#" + i.name);
		d.length && (r.isShown || d.off(a), d.remove()), d = t('<div id="' + i.name + '" class="modal modal-trigger ' + (i.className ||
				"") + '">' + ("string" == typeof i.loadingIcon && 0 === i.loadingIcon.indexOf("icon-") ?
				'<div class="icon icon-spin loader ' + i.loadingIcon + '"></div>' : i.loadingIcon) +
		...
		).appendTo("body").data(n, r);
		var p = function(e, n) {
			var o = i[e];
			t.isFunction(o) && d.on(n + a, o)
		};
		p("onShow", "show"), p("shown", "shown"), p("onHide", "hide"), p("hidden", "hidden"), p("loaded", "loaded"), d.on(
			"shown" + a,
			function() {
				r.isShown = !0
			}).on("hidden" + a, function() {
			r.isShown = !1
		}), this.$modal = d, this.$dialog = d.find(".modal-dialog"), i.mergeOptions && (this.options = i)
	}, r.prototype.show = function(i) {
		var a = t.extend({}, this.options, {
			url: this.$trigger ? this.$trigger.attr("href") || this.$trigger.attr("data-url") || this.$trigger.data("url") : this
				.options.url
		}, i);
		this.init(a);
		var r = this,
		...
		l.toggleClass("fade", a.fade).addClass(a.className).toggleClass("modal-loading", !this.isShown).toggleClass(
			"modal-scroll-inside", !!a.scrollInside), c.toggleClass("modal-md", "md" === a.size).toggleClass("modal-sm", "sm" ===
			a.size).toggleClass("modal-lg", "lg" === a.size).toggleClass("modal-fullscreen", "fullscreen" === a.size), h.toggle(
			a.showHeader), h.find(".modal-icon").attr("class", "modal-icon icon-" + a.icon), h.find(".modal-title-name").text(
			a.title || ""), a.size && "fullscreen" === a.size && (a.width = "", a.height = "");
		var f = function() {
				clearTimeout(this.resizeTask), this.resizeTask = setTimeout(function() {
					r.ajustPosition(a.position)
				}, 100)
			},
			g = function(t, e) {
				return "undefined" == typeof t && (t = a.delay), setTimeout(function() {
					c = l.find(".modal-dialog"), a.width && "auto" != a.width && c.css("width", a.width), a.height && "auto" != a.height &&
						(c.css("height", a.height), "iframe" === a.type && p.css("height", c.height() - h.outerHeight())), r.ajustPosition(
							a.position), l.removeClass("modal-loading"), "iframe" != a.type && c.off("resize." + n).on("resize." + n, f),
						e && e()
				}, t)
			};
		if ("custom" === a.type && d)
			...
			if (l.attr("ref", a.url), "iframe" === a.type) {
				l.addClass("modal-iframe"), this.firstLoad = !0;
				var y = "iframe-" + a.name;
				h.detach(), p.detach(), u.empty().append(h).append(p), p.css("padding", 0).html('<iframe id="' + y + '" name="' +
					y + '" src="' + a.url +
				...
				), a.waittime > 0 && (r.waitTimeout = g(a.waittime, v));
				var b = document.getElementById(y);
				b.onload = b.onreadystatechange = function() {
					var i = !!a.scrollInside;
					if (r.firstLoad && l.addClass("modal-loading"), !this.readyState || "complete" == this.readyState) {
						r.firstLoad = !1, a.waittime > 0 && clearTimeout(r.waitTimeout);
						try {
							l.attr("ref", b.contentWindow.location.href);
							var o = e.frames[y].$;
							if (o && "auto" === a.height && "fullscreen" != a.size) {
								var s = o("body").addClass("body-modal").toggleClass("body-modal-scroll-inside", i);
								a.iframeBodyClass && s.addClass(a.iframeBodyClass);
								var c = [],
									d = function(n) {
										l.removeClass("fade");
										var o = s.outerHeight();
										if (n === !0 && a.onlyIncreaseHeight && (o = Math.max(o, p.data("minModalHeight") || 0), p.data(
												"minModalHeight", o)), i) {
											var r = a.headerHeight;
											"number" != typeof r ? r = h.height() : t.isFunction(r) && (r = r(h));
											var d = t(e).height();
											o = Math.min(o, d - r)
										}
										for (c.length > 1 && o === c[0] && (o = Math.max(o, c[1])), c.push(o); c.length > 2;) c.shift();
										p.css("height", o), a.fade && l.addClass("fade"), g()
									};
								l.callComEvent(r, "loaded", {
									modalType: "iframe",
									jQuery: o
								}), setTimeout(d, 100), s.off("resize." + n).on("resize." + n, d), i && t(e).off("resize." + n).on("resize." +
									n, d)
							} else g()
						} catch (u) {
							g()
				...
				success: function(i) {
					try {
						var n = t(i);
						n.filter(".modal-dialog").length ? c.replaceWith(n) : n.filter(".modal-content").length ? c.find(
							".modal-content").replaceWith(n) : p.wrapInner(n)
					} catch (a) {
		...
		l.modal({
			...
			keyboard: a.keyboard,
			scrollInside: a.scrollInside
		})
	}, r.prototype.close = function(i, n) {
		var o = this;
		(i || n) && o.$modal.on("hidden" + a, function() {
			t.isFunction(i) && i(), typeof n === s && n.length && !o.$modal.data("cancel-reload") && ("this" === n ? e.location
				.reload() : e.location = n)
		}), o.$modal.modal("hide")
		...
		return t(this).each(function() {
			...
			a || o.data(n, a = new r(l, o)), typeof e == s ? a[e](i) : l.show && a.show(i), o.on((l.trigger || "click") +
				".toggle." + n,
				function(e) {
					l = t.extend(l, {
						url: o.attr("href") || o.attr("data-url") || o.data("url") || l.url
					}), a.toggle(l), o.is("a") && e.preventDefault()
				})
		})
	};
	var l = t.fn.modal;
	...
	var c = function(e) {
		...
		d = function(i, o, a) {
			...
			i = c(i), i && i.length ? i.each(function() {
				...
				}) : t("body").hasClass("modal-open") || t(".modal.in").length || t("body").hasClass("body-modal") && e.parent.$.zui
				.closeModal(s, o, a)
		},
		p = function(t, e) {
			e = c(e), e && e.length && e.modal("ajustPosition", t)
		};
	t.zui({
		closeModal: d,
		...
		a && a.length || (i.data(n) ? i.trigger(".toggle." + n) : i.modalTrigger({
			show: !0
	...
	e.DEFAULTS = {
		...
		for (var o = this.options.trigger.split(" "), a = o.length; a--;) {
			...
			if ("click" == s) this.$element.on("click." + this.type, this.options.selector, t.proxy(this.toggle, this));
				...
				this.$element.on(r + "." + this.type, this.options.selector, t.proxy(this.enter, this)), this.$element.on(l + "." +
		...
		var i = e instanceof this.constructor ? e : t(e.currentTarget)[this.type](this.getDelegateOptions()).data("zui." +
			this.type);
		return clearTimeout(i.timeout), i.hoverState = "in", i.options.delay && i.options.delay.show ? void(i.timeout =
			setTimeout(function() {
		...
		if ((e || this.hasContent()) && this.enabled) {
			...
			if (r) {
				...
				a = "bottom" == a && l.top + l.height + d - u > g ? "top" : "top" == a && l.top - u - d < 0 ? "bottom" : "right" ==
					a && l.right + c > f ? "left" : "left" == a && l.left - c < m ? "right" : a, o.removeClass(h).addClass(a)
			}
		...
		if ("top" == e && c != a && (i = !0, t.top = t.top + a - c), /bottom|top/.test(e)) {
			var d = 0;
			t.left < 0 && (d = t.left * -2, t.left = 0, n.offset(t), l = n[0].offsetWidth, c = n[0].offsetHeight), this.replaceArrow(
				d - o + l, l, "left")
		...
		var e = this.tip(),
			i = t || this.getTitle();
		this.options.tipId && e.attr("id", this.options.tipId), this.options.tipClass && e.addClass(this.options.tipClass),
			e.find(".tooltip-inner")[this.options.html ? "html" : "text"](i), e.removeClass("fade in top bottom left right")
		...
		if (this.$element.trigger(o), !o.isDefaultPrevented()) return n.removeClass("in"), t.support.transition && this.$tip
			.hasClass("fade") ? n.one(t.support.transition.end, e).emulateTransitionEnd(150) : e(), this.$element.trigger(
				"hidden.zui." + this.type), this
	...
	e.DEFAULTS = t.extend({}, t.fn.tooltip.Constructor.DEFAULTS, {
		...
		function() {
			...
			var i = this.getTitle(),
				n = this.getContent();
			t.find(".popover-title")[this.options.html ? "html" : "text"](i), t.find(".popover-content")[this.options.html ?
				"html" : "text"](n), t.removeClass("fade top bottom left right in"), this.options.tipId && t.attr("id", this.options
				.tipId), this.options.tipClass && t.addClass(this.options.tipClass), t.find(".popover-title").html() || t.find(
				".popover-title").hide()
		}, e.prototype.hasContent = function() {
	...
	function e() {
		t(o).remove(), t(a).each(function(e) {
			var o = i(t(this));
			o.hasClass("open") && (o.trigger(e = t.Event("hide." + n)), e.isDefaultPrevented() || o.removeClass("open").trigger(
				"hidden." + n))
		})
	}
	...
	s.prototype.toggle = function(o) {
		...
		if (!a.is(".disabled, :disabled")) {
			var s = i(a),
				r = s.hasClass("open");
			if (e(), !r) {
				if ("ontouchstart" in document.documentElement && !s.closest(".navbar-nav").length && t(
						'<div class="dropdown-backdrop"/>').insertAfter(t(this)).on("click", e), s.trigger(o = t.Event("show." + n)), o.isDefaultPrevented())
					return;
...
function(t, e) {
	...
	var i = "zui.contextmenu",
		...
		d = function(e, i) {
			...
			return e.html ? n.html(e.html === !0 ? e.label || e.text : e.html) : n.text(e.label || e.text), e.onClick && n.on(
				"click", e.onClick), t("<li />").toggleClass("disabled", e.disabled === !0).append(n)
		},
		p = null,
		h = function(e, i) {
		...
		u = function(c, u, f) {
			...
			var g = u.x,
				m = u.y;
			g === e && (g = (u.event || u).clientX), g === e && (g = r), m === e && (m = (u.event || u).clientY), m === e && (m =
				l);
			var v = t("#" + s);
			v.length || (v = t('<div style="display: none; position: fixed; z-index: 2000;" class="contextmenu" id="' + s +
				'"><ul class="dropdown-menu contextmenu-menu"></ul></div>').appendTo("body"));
			...
			var T = t(window);
			return g = Math.max(0, Math.min(g, T.width() - y.outerWidth())), m = Math.max(0, Math.min(m, T.height() - y.outerHeight())),
				v.css({
					left: g,
					top: m
	...
	var f = function(e, n) {
		...
		var r = function(t) {
				if ("mousedown" !== t.type || 2 === t.button) {
					...
					return n.itemsCreator && (e.items = n.itemsCreator.call(this, t)), o.show(e), t.preventDefault(), t.returnValue = !
						1, !1
				}
			},
			l = s + "." + i;
	...
	"use strict";
	var e = function(e, i) {
		this.$element = t(e), this.$indicators = this.$element.find(".carousel-indicators"), this.options = i, this.paused =
			this.sliding = this.interval = this.$active = this.$items = null, "hover" == this.options.pause && this.$element.on(
				"mouseenter", t.proxy(this.pause, this)).on("mouseleave", t.proxy(this.cycle, this))
	};
	e.DEFAULTS = {
		interval: 5e3,
		pause: "hover",
		...
		return e || (this.paused = !0), this.$element.find(".next, .prev").length && t.support.transition.end && (this.$element
		...
		if (!o.hasClass("active")) {
			if (this.$indicators.length && (this.$indicators.find(".active").removeClass("active"), this.$element.one("slid",
				...
				o.addClass(e), o[0].offsetWidth, n.addClass(s), o.addClass(s), n.one(t.support.transition.end, function() {
					o.removeClass([e, s].join(" ")).addClass("active"), n.removeClass(["active", s].join(" ")), l.sliding = !1,
						setTimeout(function() {
	...
	t.fn.carousel = function(i) {
		return this.each(function() {
			...
			o || n.data("zui.carousel", o = new e(this, a)), "number" == typeof i ? o.to(i) : s ? o[s]() : a.interval && o.pause()
				.cycle(), a.touchable && o.touchable()
		})
...
function(t) {
	...
	t.zui.imgReady = function() {
		...
		return function(n, o, a, s) {
			...
			return h.src = n, h.complete ? (o.call(h), void(a && a.call(h))) : (l = h.width, c = h.height, h.onerror =
				function() {
...
function(t, e, i) {
	...
	n.DEFAULTS = {
		...
		var i = "image";
		return e = t.extend({}, n.DEFAULTS, this.$.data(), e), e[i] || (e[i] = this.$.attr("src") || this.$.attr("href") ||
			this.$.find("img").attr("src"), this.$.data(i, e[i])), e
	}, n.prototype.init = function() {
		this.bindEvents()
	}, n.prototype.initGroups = function() {
		var e = this.$.data("groups");
		e || (e = t('[data-toggle="lightbox"][data-group="' + this.options.group + '"], [data-lightbox-group="' + this.options
			.group + '"]'), this.$.data("groups", e), e.each(function(e) {
		...
		return !!a.image && void n.modalTrigger({
			...
			custom: function(n) {
				...
				var s = n.modal,
					r = o.groups,
					l = o.groupIndex;
				s.addClass("modal-lightbox").html(a.modalTeamplate.format(a)).toggleClass("lightbox-with-caption", "string" ==
					typeof a.caption).removeClass("lightbox-full").data("group-index", l);
				...
				t.zui.imgReady(a.image, function() {
				...
				}), s.find(".prev").toggleClass("show", r.filter('[data-group-index="' + (l - 1) + '"]').length > 0), s.find(
					".next").toggleClass("show", r.filter('[data-group-index="' + (l + 1) + '"]').length > 0), s.find(
					...
					if (l.length) {
						var p = l.data("image"),
							h = l.data("caption");
						s.addClass("modal-loading").data("group-index", a).toggleClass("lightbox-with-caption", "string" == typeof h)
							.removeClass("lightbox-full"), s.find(".lightbox-img").attr("src", p), s.find(".caption > .content").text(
								h), d = t(e).width(), t.zui.imgReady(p, function() {
								c.css({
									width: i.min(d, this.width)
								}), d < this.width + 30 && s.addClass("lightbox-full"), n.ready()
							})
					}
					return s.find(".prev").toggleClass("show", r.filter('[data-group-index="' + (a - 1) + '"]').length > 0), s.find(
						".next").toggleClass("show", r.filter('[data-group-index="' + (a + 1) + '"]').length > 0), !1
				})
			}
		})
		...
		return this.each(function() {
			var o = t(this),
				a = "object" == typeof e && e;
			"object" == typeof a && a.group ? o.attr("data-lightbox-group", a.group) : o.data("group") ? o.attr(
				"data-lightbox-group", o.data("group")) : o.attr("data-lightbox-group", i), o.data("group", o.data(
				"lightbox-group"));
...
function(t, e, i) {
	...
	var n = 0,
		...
		r = function(e, r) {
			...
			var c = s[l.id];
			c && c.destroy(), s[l.id] = l, l.message = (r.icon ? '<i class="icon-' + r.icon + ' icon"></i> ' : "") + e, l.$ = t(
					o.format(r)).toggleClass("fade", r.fade).toggleClass("scale", r.scale).attr("id", "messager-" + l.id), r.cssClass &&
				l.$.addClass(r.cssClass);
			var d = !1,
				...
				h = function(e) {
					...
					"close" === e.name && n.addClass("close"), e.html !== i && n.html(e.html), e.icon !== i && n.append(
						'<i class="action-icon icon-' + e.icon + '"/>'), e.text !== i && n.append('<span class="action-text">' + e.text +
						"</span>"), e.tooltip !== i && n.attr("title", e.tooltip).tooltip(), n.data("action", e), p.append(n)
				};
			r.actions && t.each(r.actions, function(t, e) {
				...
				r.onAction && (i = r.onAction.call(this, n.name, n, l), i === !1) || t.isFunction(n.action) && (i = n.action.call(
					this, l), i === !1) || (l.hide(), e.stopPropagation())
	...
	r.prototype.update = function(e, i) {
		var n = this,
			o = n.options;
		n.$.removeClass("messager-" + o.type), i && (o = t.extend(o, i)), n.$.addClass("messager-" + o.type), e && (n.message =
			(o.icon ? '<i class="icon-' + o.icon + ' icon"></i> ' : "") + e, n.$.find(".messager-content").html(n.message))
...
function(t, e, i, n) {
	...
	function s(t) {
		function e(t) {
			return t = t < 0 ? t + 1 : t > 1 ? t - 1 : t, 6 * t < 1 ? r + (s - r) * t * 6 : 2 * t < 1 ? s : 3 * t < 2 ? r + (s -
				r) * (2 / 3 - t) * 6 : r
		}
		var i = t.h,
			n = t.s,
	...
	var d = /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/,
		...
		C = function(t, e, i, n) {
			var a = this;
			if (a.r = a.g = a.b = 0, a.a = 1, y(n) && (a.a = l(c(n), 1)), y(t) && y(e) && y(i)) a.r = w(t), a.g = w(e), a.b = w(
				i);
			else if (y(t)) {
				var r = typeof t;
				if (r == f)
					if (t = t.toLowerCase(), "transparent" === t) a.a = 0;
					else if (m[t]) a.rgb(o(m[t]));
				else if (0 === t.indexOf("rgb")) {
					var d = t.substring(t.indexOf("(") + 1, t.lastIndexOf(")")).split(",", 4);
					a.rgb({
						r: d[0],
						g: d[1],
						b: d[2],
				...
				else if (r == g && y(t.r)) a.r = w(t.r), y(t.g) && (a.g = w(t.g)), y(t.b) && (a.b = w(t.b)), y(t.a) && (a.a = l(c(t
					.a), 1));
				else if (r == g && y(t.h)) {
					var p = {
						h: l(c(t.h), h),
					...
					y(t.s) && (p.s = l(c(t.s), 1)), y(t.l) && (p.l = l(c(t.l), 1)), y(t.a) && (p.a = l(c(t.a), 1)), a.rgb(s(p))
				}
			}
		};
	C.prototype.rgb = function(t) {
		var e = this;
		if (y(t)) {
			if (typeof t == g) y(t.r) && (e.r = w(t.r)), y(t.g) && (e.g = w(t.g)), y(t.b) && (e.b = w(t.b)), y(t.a) && (e.a = l(
				c(t.a), 1));
			else {
				var i = b(c(t));
				e.r = i, e.g = i, e.b = i
		...
		var t = this.r / p,
			i = this.g / p,
			n = this.b / p;
		return t = t <= .03928 ? t / 12.92 : e.pow((t + .055) / 1.055, 2.4), i = i <= .03928 ? i / 12.92 : e.pow((i + .055) /
			1.055, 2.4), n = n <= .03928 ? n / 12.92 : e.pow((n + .055) / 1.055, 2.4), .2126 * t + .7152 * i + .0722 * n
		...
		return 1 == t.length && (t = "0" + t), 1 == e.length && (e = "0" + e), 1 == i.length && (i = "0" + i), "#" + t + e +
			i
	...
	a.DEFAULTS = {
		...
		if (r.is("li") ? (s = r.children("ul"), s.length || (s = t("<ul/>"), r.append(s), this._initList(s, r))) : s = r, s) {
			...
			t.isArray(i) || (i = [i]), t.each(i, function(e, i) {
				...
				var o = l.itemWrapper ? t(l.itemWrapper === !0 ? '<div class="tree-item-wrapper"/>' : l.itemWrapper).appendTo(n) :
					n;
		...
		var i = this;
		e && (i.$.empty(), i.add(i.$, e)), i.isPreserve && i.store.time && i.$.find("li:not(.tree-action-item)").each(
			function() {
				var e = t(this);
		...
		var r = this;
		n.hasClass("tree") ? (a = 0, o = null) : (o = (o || n.closest("li")).addClass("has-list"), o.find(".list-toggle").length ||
			o.prepend(this.options.toggleTemplate), a = a || o.data("idx")), n.removeClass("has-active-item");
		...
		if (c) {
			if (c.add && c.add.templateInList !== !1) {
				...
				d.length ? d.detach().appendTo(n) : t('<li class="tree-action-item"/>').append(i(c.add, "add", c.add.templateInList))
					.appendTo(n)
			}
		...
		if (c) {
			...
			d.length || (d = t('<div class="tree-actions"/>').appendTo(this.options.itemWrapper ? n.find(".tree-item-wrapper") :
				n), t.each(c, function(t, e) {
				e && d.append(i(e, t))
			}))
		}
		var p = n.children("ul");
		...
		var i = this.options,
			a = this;
		this.actions = e(i.actions), this.$.addClass("tree"), i.animate && this.$.addClass("tree-animate"), this._initList(
			this.$);
		var s = i.initialState,
			r = t.zui && t.zui.store && t.zui.store.enable;
		r && (this.selector = n + "::" + (i.name || "") + "#" + (this.$.attr("id") || o++), this.store = t.zui.store[i.name ?
				"get" : "pageGet"](this.selector, {})), "preserve" === s && (r ? this.isPreserve = !0 : this.options.initialState =
				s = "normal"), this.reload(i.data), r && (this.isPreserve = !0), "expand" === s ? this.expand() : "collapse" ===
			s && this.collapse(), this.$.on("click", '.list-toggle,a[href="#"],.tree-toggle', function(e) {
				var i = t(this),
					n = i.parent("li");
				a.callEvent("hit", {
					target: n,
		...
		if (this.isPreserve)
			if (e) i = i || e.data("id"), n = void 0 === n && e.hasClass("open"), n ? this.store[i] = n : delete this.store[i],
				this.store.time = (new Date).getTime(), t.zui.store[this.options.name ? "set" : "pageSet"](this.selector, this.store);
			else {
				var o = this;
		...
		t ? (t.addClass("open"), !e && this.options.animate ? setTimeout(function() {
			t.addClass("in")
		}, 10) : t.addClass("in")) : t = this.$.find("li.has-list").addClass("open in"), i || this.preserve(t), this.callEvent(
			"expand", t, this)
		...
		t ? !e && this.options.animate ? (t.removeClass("in"), setTimeout(function() {
				t.removeClass("open")
			}, 300)) : t.removeClass("open in") : t = this.$.find("li.has-list").removeClass("open in"), i || this.preserve(t),
		...
		this.options = t.extend({}, a.DEFAULTS, this.$.data(), e), null === this.options.animate && this.$.hasClass(
		...
		var n;
		return t.isFunction(this.options[e]) && (n = this.options[e](i, this)), this.$.trigger(t.Event(e + "." + this.name,
			i)), n
