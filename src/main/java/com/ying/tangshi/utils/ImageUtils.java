...
public class ImageUtils {
    ...
    /**
     * 图像切割(按指定起点坐标和宽高切割)
     * @param srcImageFile 源图像地址,切割后上传到tfs
     * @param x 目标切片起点坐标X
     * @param y 目标切片起点坐标Y
     * @param width 目标切片宽度
     * @param height 目标切片高度
     */
    public final static InputStream cut(String srcImageFile,
    ...
    public static void main(String[] args) {
        ...
        // 方法二：指定切片的行数和列数
        ImageUtils.cut("e:/abc.jpg", "e:/", 2, 2,null);//测试OK
        // 方法三：指定切片的宽度和高度
        ImageUtils.cut("e:/abc.jpg", "e:/", 300, 300 );//测试OK
